  ...
  return (
    <div className="min-h-screen bg-[#FFF8E1] text-[#3E2723] flex flex-col font-sans">
      ...
      <header className="sticky top-0 z-50 bg-[#FFF8E1]/95 backdrop-blur-md border-b-2 border-[#FBC02D]/30">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center max-w-7xl">
          ...
          <div className="hidden md:flex gap-8 font-bold text-sm text-[#3E2723]">
            ...
            <a href="https://wa.me/556599364197?text=Ol%C3%A1%21%20Quero%20garantir%20minha%20encomenda%20VIP%20na%20P%C3%A3es%20%26%20Del%C3%ADcias." target="_blank" rel="noopener noreferrer" className="hover:text-[#E64A19] transition-colors">Encomendas Rápida</a>
          </div>
      ...
      <main className="flex-1">
        {/* Hero Section (A Grande Promessa - Minimalista com Vídeo) */}
        <section className="relative w-full h-[85vh] md:h-[90vh] flex flex-col -mt-[2px] mb-16">
          {/* Video Background */}
          ...
          {/* Hero Content */}
          <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-6 max-w-5xl mx-auto space-y-8">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/30 px-4 py-1.5 rounded-full mb-2">
              <span className="relative flex h-3 w-3">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#25D366] opacity-75"></span>
                <span className="relative inline-flex rounded-full h-3 w-3 bg-[#25D366]"></span>
              </span>
              <span className="text-xs md:text-sm font-bold text-white tracking-wide uppercase">Pedidos Abertos para o Final de Semana</span>
            </div>
            
            <h1 className="font-serif text-5xl md:text-7xl lg:text-[6rem] leading-[1.05] font-black text-white max-w-5xl">
              A tradição que Arenápolis ama, <br/><span className="text-[#FBC02D] italic font-light">agora a um clique da sua mesa.</span>
            </h1>
            
            <p className="text-lg md:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed font-light tracking-wide">
            ...
            <div className="pt-8 w-full md:w-auto flex flex-col items-center gap-4">
              ...
              <div className="flex items-center gap-2 text-sm md:text-base font-bold text-white/90 mt-2">
              ...
              <div key={idx} className="group relative bg-white rounded-3xl overflow-hidden border-2 border-[#FBC02D]/30 shadow-lg hover:shadow-2xl hover:border-[#FBC02D] transition-all duration-500 flex flex-col">
                ...
                <div className="p-6 md:p-8 flex-1 flex flex-col justify-between gap-4">
                  ...
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 text-[#E64A19] font-bold hover:gap-3 transition-all"
                  >
        ...
        <section id="encomendas" className="container mx-auto px-6 py-24 max-w-4xl text-center space-y-10">
          ...
          <div className="bg-white p-8 md:p-12 rounded-3xl border-[3px] border-[#FBC02D] shadow-2xl flex flex-col items-center gap-6 relative">
            ...
            <a 
              href="https://wa.me/556599364197?text=Ol%C3%A1%21%20Gostaria%20de%20garantir%20minha%20encomenda%20VIP%20na%20P%C3%A3es%20%26%20Del%C3%ADcias." 
              target="_blank"
              rel="noopener noreferrer"
