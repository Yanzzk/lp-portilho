        ...
        <section className="relative w-full min-h-[85vh] flex flex-col justify-center items-center overflow-hidden bg-[#2D1B18] pt-12 md:pt-16">
          ...
          <div className="relative z-20 w-full px-4 md:px-6 max-w-5xl mx-auto flex flex-col items-center text-center pt-24 pb-12 md:pt-16 md:pb-0 mt-8 md:mt-0">
            ...
            <div className="pt-8 w-full md:w-auto flex flex-col items-center gap-4">
              ...
              <div className="mt-8 relative group flex items-center gap-3 bg-black/20 backdrop-blur-xl border border-white/10 pl-3 pr-5 py-2.5 rounded-full shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:bg-white/10 hover:border-white/20 hover:scale-105 transition-all duration-300 overflow-hidden cursor-default">
                ...
                <div className="relative flex flex-col items-start gap-0.5">
                  <div className="flex items-center gap-1.5">
                    ...
                    <div className="flex gap-0.5 group-hover:scale-105 transition-transform duration-300">
                      {[1, 2, 3, 4, 5].map((_, i) => (
                        <Star key={i} className="w-3.5 h-3.5 fill-[#FBC02D] text-[#FBC02D] drop-shadow-[0_0_3px_rgba(251,192,45,0.8)] animate-in zoom-in fade-in duration-500 fill-mode-both" style={{ animationDelay: `${300 + (i * 100)}ms` }} />
                      ))}
                    </div>
                  </div>
                  <span className="text-white/80 text-[10px] md:text-[11px] font-semibold tracking-wider">
